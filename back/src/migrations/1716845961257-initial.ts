...
export class Initial1716845961257 implements MigrationInterface {
  name = 'Initial1716845961257';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "orders_detail" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "price" numeric(10,2) NOT NULL, "orderId" uuid, "productId" uuid, CONSTRAINT "PK_893f1d90444c486c31023ff1d8e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "orders_detail" ADD CONSTRAINT "FK_ad9d5547c0ea6fc807e3954c5b2" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "orders_detail" DROP CONSTRAINT "FK_ad9d5547c0ea6fc807e3954c5b2"`,
    );
    await queryRunner.query(
